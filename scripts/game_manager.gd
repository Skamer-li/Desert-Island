...
var items = ["bananas", "coconut", "crabs", "roasted_iguana", "sprats", "candelabrum", 
			 ...
			 "spear", "medicine", "boarding_saber", "trap", "bananas", "bananas", "coconut",
			 "coconut", "crabs", "crabs", "roasted_iguana", "roasted_iguana", "sprats", "sprats", 
			 "doubloons", "doubloons", "doubloons", "doubloons", "shovel", "tent"]
var items_database = [
